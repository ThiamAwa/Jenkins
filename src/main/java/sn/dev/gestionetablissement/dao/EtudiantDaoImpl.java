...
public class EtudiantDaoImpl implements EtudiantDoa{
    @Override
    public void flush() {
    ...
    @Override
    public Etudiant getOne(Long aLong) {
        return null;
    }

    @Override
    public Etudiant getById(Long aLong) {
        return null;
    }

    @Override
    public Etudiant getReferenceById(Long aLong) {
        return null;
    }
    ...
    @Override
    public List<Etudiant> findAllById(Iterable<Long> longs) {
        return List.of();
    }
